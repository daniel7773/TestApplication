 ...
 *******************************************************************************/
package com.example.testapp.imageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.example.testapp.imageloader.cache.disc.DiskCache;
import com.example.testapp.imageloader.cache.disc.naming.FileNameGenerator;
import com.example.testapp.imageloader.cache.memory.MemoryCache;
import com.example.testapp.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.example.testapp.imageloader.core.assist.FlushedInputStream;
import com.example.testapp.imageloader.core.assist.ImageSize;
import com.example.testapp.imageloader.core.assist.QueueProcessingType;
import com.example.testapp.imageloader.core.decode.ImageDecoder;
import com.example.testapp.imageloader.core.download.ImageDownloader;
import com.example.testapp.imageloader.core.process.BitmapProcessor;
import com.example.testapp.imageloader.utils.L;
import com.example.testapp.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.example.testapp.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.example.testapp.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.example.testapp.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.example.testapp.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.example.testapp.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.example.testapp.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.example.testapp.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.example.testapp.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.example.testapp.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.example.testapp.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.example.testapp.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.example.testapp.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.example.testapp.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.example.testapp.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
